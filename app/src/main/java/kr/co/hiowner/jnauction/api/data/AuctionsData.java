...
public class AuctionsData {
    ...
    public static class Resultfdg {
        ...
        private List<Auctionsfdg> auctions;
        ...
        public List<Auctionsfdg> getAuctions() {
            return auctions;
        }

        public void setAuctions(List<Auctionsfdg> auctions) {
            this.auctions = auctions;
        }

        public static class Auctionsfdg {
