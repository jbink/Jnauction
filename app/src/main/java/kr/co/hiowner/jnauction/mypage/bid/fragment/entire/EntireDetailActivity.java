 ...
 */
public class EntireDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entire_detail);

        mContext = EntireDetailActivity.this;
//        mCarData = getIntent().getParcelableExtra("car_data");
        ...
        mTvCarLocAddr = (TextView)findViewById(R.id.entire_detail_txt_car_loc_addr);
        mTvCarNumber = (TextView)findViewById(R.id.entire_detail_txt_car_number);
        mTvBidCount = (TextView)findViewById(R.id.entire_detail_txt_bid_count);
        mTvRemainTime = (TextView)findViewById(R.id.entire_detail_txt_remain_time);
...
//        new TimeAsyncTask().execute();
    ...
    public void onClick(View v){
        Intent intent;
        switch (v.getId()){
            case R.id.entire_detail_btn_back :
            case R.id.entire_detail_layout_back :
                if(mBoolResult == true){
                    setResult(RESULT_OK);
                    finish();
                }else{
