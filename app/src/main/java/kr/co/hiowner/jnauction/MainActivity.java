...
public class MainActivity extends AppCompatActivity {
    ...
    //레이아웃관련 1:매입신청청 2:이페이지
    LinearLayout mLayoutMain_1;
    ScrollView mLayoutMain_2;
...
//        String url = "http://joongna.hiowner.co.kr/api/auctions?token="+"2edd9b04b8aa6288b867dcc253e16f06"+"&mybid=N&order=bid_desc&limit=100&offset=1&min_status=100&max_status=299";
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.main_btn_layout_1 ://매입신청
                mLayoutMain_1.setVisibility(View.VISIBLE);
                mLayoutMain_2.setVisibility(View.GONE);
                ...
                break;
            case R.id.main_btn_layout_2 ://마이페이지
                mLayoutMain_1.setVisibility(View.GONE);
                mLayoutMain_2.setVisibility(View.VISIBLE);
