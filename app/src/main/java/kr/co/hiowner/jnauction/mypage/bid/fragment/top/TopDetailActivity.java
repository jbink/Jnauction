    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.top_detail_layout_back :
                ...
                break;
            case R.id.top_detail_btn_insurance_history :
...
//                mBtnTender.setTextColor(ContextCompat.getColor(mContext, R.color.text_color_b3b3b3));
        ...
        try {
            ...
            if(bid_count >= 2){
                ((ImageButton)findViewById(R.id.top_detail_btn_car_my_retry)).setVisibility(View.GONE);
            }else{
                ((ImageButton)findViewById(R.id.top_detail_btn_car_my_retry)).setVisibility(View.VISIBLE);
            }
        }catch (Exception e){
